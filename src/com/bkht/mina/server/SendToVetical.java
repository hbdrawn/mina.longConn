...
public class SendToVetical {
	...
	public static void send2Vetical(String msg) throws Exception {
		...
		if (msg.equals("0x9521")) {
			...
			wrapper = new MsgWrapper("0x9521", new BodyPros("0", "000",
					(short) t0x9521.getBody().length), carId, (short) 1, null,
					t0x9521.getBody());
		} else if (msg.equals("0x9560")) {
			// 询问终端状态，消息体为空
			wrapper = new MsgWrapper("0x9560", new BodyPros("0", "000",
					(short) 0), carId, (short) 1, null, null);
		} else if (msg.equals("0x9561")) {
			// 服务器删除终端订单
			M0x9561 m0x9561 = new M0x9561();
			m0x9561.setIdentify("198098783920989834");
			wrapper = new MsgWrapper("0x9561", new BodyPros("0", "000",
			...
			biaozhi[0] = 0x02;
			wrapper = new MsgWrapper("0x9562", new BodyPros("0", "000",
					(short) biaozhi.length), carId, (short) 1, null, biaozhi);
		} else if (msg.equals("0x9563")) {
			// 服务器下发强制开门/关门
			byte[] biaozhi = new byte[1];
			biaozhi[0] = 0x01;
			wrapper = new MsgWrapper("0x9563", new BodyPros("0", "000",
					(short) biaozhi.length), carId, (short) 1, null, biaozhi);
			...
			// 查询终端参数,消息体为空
			wrapper = new MsgWrapper("0x8107", new BodyPros("0", "000",
					(short) 0), carId, (short) 1, null, null);
