...
class MyKeepAliveFilter extends KeepAliveFilter {
    ...
    MyKeepAliveFilter(KeepAliveMessageFactory messageFactory) {
        super(messageFactory, IdleStatus.BOTH_IDLE, KeepAliveRequestTimeoutHandler.NOOP, INTERVAL, TIMEOUT);
    }

    MyKeepAliveFilter() {
        super(new KeepAliveMessageFactoryImpl(), IdleStatus.BOTH_IDLE, KeepAliveRequestTimeoutHandler.NOOP, INTERVAL,
                TIMEOUT);
